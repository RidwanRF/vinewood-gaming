...
--------------------------------
function toggleRoadShader( bool )
	if ( bool ) then
		enableRoadshine3()
	else
		disableRoadshine3()
...
addEventHandler( "onClientPlayerSettingChange", root,
	function ( setting, newValue, oldValue )
		if ( setting == "shader1" ) then
			toggleRoadShader( newValue )
		end
	end
)
...
addEventHandler( "onClientResourceStart", resourceRoot,
	function ( )
		if ( exports.VGsettings:getPlayerSetting( "shader1" ) ) then
			toggleRoadShader( true )
		end
	end
)
